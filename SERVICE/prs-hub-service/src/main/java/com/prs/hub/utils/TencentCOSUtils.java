...
public class TencentCOSUtils {
    ...
    public void deleteFile(String key) {
        ...
        COSClient cosClient = this.getCOSClient();
        try {
            DeleteObjectRequest deleteRequest = new DeleteObjectRequest(cosConfig.getBucketName(), key);
    ...
    public void deleteFolder(String folderKey) {
        log.info("删除文件夹：{}",folderKey);
        COSClient cosClient = this.getCOSClient();
        ListObjectsRequest listRequest = new ListObjectsRequest(cosConfig.getBucketName(),cosConfig.getFolderPrefix(),null,null,null);
        listRequest.setPrefix(folderKey);
        ...
        try {
            ...
            log.error("删除文件夹异常：{}",e.getMessage());
        }finally {
            cosClient.shutdown();
        }
        log.info("删除文件夹成功");
